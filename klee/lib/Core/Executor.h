...
private:
  ...
  /// @brief [SGS]: Check whether is using SGS
  bool sgsUsingFlag;

  /// @brief [SGS] Subpath counts
  ...
  time::Point startWallTime = time::getWallTime();
